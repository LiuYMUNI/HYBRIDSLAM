...
int main(int argc, char **argv)
{
  ...
  no.param<double>("mapping/degenerate_index_mean_thres", degenerate_index_mean_thres, 2000);
            ...
            if(frame_time >= lidar_time_front)
            {
                ...
                else
                {
                    ...
                    if(bVIBA0)
                    {
                        ...
                        if(globalLidarProcess.dSum  >= 6000)
                        {
                            if(globalcounter == 0)
                            {
                                globalcounter = 0;
                            ...
                            {
                                if(degenerate_index_mean < 3000)
                                {
                                    globalcounter = globalcounter - 2;
                                }
                                else if(degenerate_index_mean >= 3000 && degenerate_index_mean < 6000)
                                {
                                    globalcounter = globalcounter - 10;
                                }
                                else if( degenerate_index_mean >= 6000)
                                {
                        ...
                        else if(globalLidarProcess.dSum < 6000 && globalLidarProcess.dSum >= 1000)
                        {
                            if(globalcounter == 0)
                            {
                                globalcounter = 0;
                            ...
                            else if( globalcounter > 0)
                            {
                                ...
                                {
                                    globalcounter = globalcounter - 15;
                                }
                        ...
                        else if(globalLidarProcess.dSum < 1000)
                        {
                            globalcounter = 45;
                            std::cout << "dSum < 1000" << std::endl;
                        }
                        else if( globalLidarProcess.dSum<600)
                        {
                            globalcounter = 60;
                            std::cout << "dSum < 600" << std::endl;
                        }
                        if(degenerate_index_mean < degenerate_index_mean_thres)
                        {
