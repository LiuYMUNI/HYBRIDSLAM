  ...
  while(status)
  {
    ...
    if(globalMeasures.frame_or_not)
    {
        ...
        //   pcl::copyPointCloud(*feats_down_body, *feats_down_body_fororb);
          ...
          if(degenerate_index_mean<degenerate_index_mean_thres)
          {
            kf.update_iterated_dyn_share_modified(0.1, solve_H_time);
          }
          else
          {
            ...
            if(frame_time >= lidar_time_front)
            {
                ...
                else
                {
                    ...
                    if(bVIBA0)
                    {
                        ...
                        // std::cout << "information_matrix = " << information_matrix << std::endl;
                        // if(globalLidarProcess.dSum < 300)
                        // {
                        //     information_matrix = Eigen::Matrix<double, 6, 6>::Identity();
                        //     globalcounter = globalcounter - 8;
                        //     if(globalcounter < 0)
                        //     {
                        //         globalcounter = 0;
                        //     }
                        // }
                        // else if(globalLidarProcess.dSum > 300 && globalLidarProcess.dSum < 600)
                        // {
                        //     information_matrix = Eigen::Matrix<double, 6, 6>::Identity();
                        ...
                        //     }
                        // }
                        // else if(globalLidarProcess.dSum > 600 && globalLidarProcess.dSum < 2000)
                        // {
                        //     if(globalcounter < 15)
                        //     {
                        //         globalcounter +=1;
                        ...
                        //     }
                        // }
                        // else if(globalLidarProcess.dSum > 2000)
                        // {
                        ...
                        std::cout << "globalLidarProcess.dSum = " << globalLidarProcess.dSum << std::endl;
                        double b = globalLidarProcess.dSum;
                        std::cout << "bvbbv = " << b << std::endl;
                        if(globalLidarProcess.dSum  >= 6000.0)
                        {
                            if(globalcounter == 0.0)
                            {
                                globalcounter = 0.0;
                            }
                            else if( globalcounter > 0.0)
                            {
                                if(degenerate_index_mean < 3000.0)
                                {
                                    globalcounter = globalcounter - 2;
                                }
                                else if(degenerate_index_mean >= 3000.0 && degenerate_index_mean < 6000.0)
                                {
                                    globalcounter = globalcounter - 10.0;
                                }
                                else if( degenerate_index_mean >= 6000.0)
                                {
                                    globalcounter = globalcounter - 20.0;
                                }
                            ...
                            std::cout << "dSum > 6000" << std::endl;
                        }
                        else if(globalLidarProcess.dSum < 6000.0 && globalLidarProcess.dSum >= 1000.0)
                        {
                            if(globalcounter == 0.0)
                            {
                                globalcounter = 0.0;
                            ...
                            else if( globalcounter > 0.0)
                            {
                                ...
                                {
                                    globalcounter = globalcounter - 5.0;
                                }
                                else if( degenerate_index_mean >= 6000.0)
                                {
                                    globalcounter = globalcounter - 15.0;
                                }
                            ...
                            std:: cout << "dSum < 6000.0" << std::endl;
                        }
                        else if(globalLidarProcess.dSum < 600.0)
                        {
                            globalcounter = 45;
                            std::cout << "dSum < 1000.0" << std::endl;
                        }
                        else if( globalLidarProcess.dSum<300.0)
                        {
                            globalcounter = 60.0;
                            std::cout << "dSum < 600.0" << std::endl;
                        }
                        if(globalcounter == 0.0)
                        {
                            if(degenerate_index_mean < degenerate_index_mean_thres)
                        ...
                        // if(globalLidarProcess.bDegenerate)
                        // {
                        //     globalcounter = globalcounter -60;
                        //     if(globalcounter < 0)
                        //     {
                        //         globalcounter = 0;
                        //     }
                        ...
                        //         globalcounter = 60;
                        //     }
                        //     // double e00 = information_matrix(0, 0);
                        //     // std::cout << "e00 = " << information_matrix(0, 0) << std::endl;
                        //     if(globalcounter < 15)
                        //     {
                        //         std::cout << "D2 " << std::endl;
                        //         information_matrix = Eigen::Matrix<double, 6, 6>::Identity();
                        ...
                        // if(globalLidarProcess.bDegenerate)
                        // {
                        //     globalcounter = globalcounter -11;
                        //     if(globalcounter < 0)
                        //     {
                        //         globalcounter = 0;
                        //     }
