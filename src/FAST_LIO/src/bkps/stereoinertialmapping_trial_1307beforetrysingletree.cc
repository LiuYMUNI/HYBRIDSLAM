            ...
            if(frame_time >= lidar_time_front)
            {
                ...
                else
                {
                    ...
                    if(bVIBA0)
                    {
                        ...
                        std::cout << "velocity b0_bn = " << velocity << std::endl;
                        Eigen::JacobiSVD<Eigen::Matrix3d> svd(R, Eigen::ComputeFullU | Eigen::ComputeFullV);
                        Eigen::Matrix3d R_b0bn = svd.matrixU() * svd.matrixV().transpose();
                        Sophus::SE3d Tb0bn;
                        Tb0bn = Sophus::SE3d(R_b0bn, t);
                        ...
                        if(globalcounter > 0)
                        {
                            ...
                            if(false)
                            {
                                ...
                                // Tcw = mpSLAM->TrackStereo_Pose_VB(imLeft,imRight,tImLeft,vImuMeas, "", Tc0bn, information_matrix, velocity_c0.cast<float>(), ba, bg);
