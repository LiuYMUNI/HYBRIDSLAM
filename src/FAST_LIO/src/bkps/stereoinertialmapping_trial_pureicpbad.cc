        ...
        if(sync_packages(Measures_))
        {
            ...
            else
            {
                ...
                else
                {
                    if(!bLoopDetected)
                    {
                        if(nLoopBuffer > 0 || nTrackICP > 0 )
                        {
                            if(nTrackICP > 0)
                            {
                                nTrackICP = nTrackICP - 1;
                            }
                            ...
                            float rmse;
                            rmse = 0.0f;
                            bRefine = refine_with_pt2pt_icp(feats_down_body, 0.1, 20, global_map.current_ikdtreeptr_, Ricp, ticp, state_point,rmse);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if(!bLoopDetected)
                                {
                                    ...
                                    else if( (nLoopBuffer == 0) || nTrackICP >0)
                                    {
