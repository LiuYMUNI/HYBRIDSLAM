                    ...
                    if(bVIBA0)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                information_matrix = 30000*Eigen::Matrix<double, 6, 6>::Identity();
                            }
                            
                            // if(e00 > 10000.0 && e00 < 100000.0)
                            // {
                            //     // 
                            //     information_matrix = information_matrix/30.0;
                            // }
                            // else if (e00 > 100000.0 && e00 >1000000.0)
                            // {
                            //     information_matrix = information_matrix/300.0;
                            // }
                            // else
                            // {
                        ...
                        Sophus::SE3f Tcw = mpSLAM->TrackStereo_Pose(imLeft,imRight,tImLeft,vImuMeas, "", Tc0bn, information_matrix);
