...
public:
    ...
    // void SetPCL(PointCloudXYZI::Ptr pfeats_down_body);
...
public:
    ...
    // pcl member
    // PointCloudXYZI::Ptr mpfeats_down_body;
    ...
    // right camera points invSigma2
    std::vector<double> mvr_invSigma2s;

    bool mbprior_pose;
    bool mbneed_reoptimize;
    bool stereo_setflag;
    Eigen::Matrix3d mRwb_p;
    Eigen::Vector3d mtwb_p;
    Eigen::Vector3d mvelocity_y_bn;
    Sophus::SE3d mTTwb_p;
    Sophus::SE3d mTc0bn;
    Eigen::Vector3f mvelocity_c0;
    Eigen::Vector3d mba_p;
    Eigen::Vector3d mbg_p;
    Eigen::Matrix<double, 6, 6> minfo_p;

    pcl::PointCloud<pcl::PointXYZINormal>::Ptr mpfeats_down_body;
