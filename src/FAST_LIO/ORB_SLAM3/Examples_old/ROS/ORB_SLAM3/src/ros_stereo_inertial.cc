...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_img_left = n.subscribe("/uas_cam2/image", 100, &ImageGrabber::GrabImageLeft,&igb);
  ros::Subscriber sub_img_right = n.subscribe("/uas_cam4/image", 100, &ImageGrabber::GrabImageRight,&igb);
