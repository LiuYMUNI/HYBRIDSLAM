...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_imu = n.subscribe("/mavros/imu/data_raw", 1000, &ImuGrabber::GrabImu, &imugb); 
  ros::Subscriber sub_img0 = n.subscribe("/uas_cam2/image", 100, &ImageGrabber::GrabImage,&igb);
