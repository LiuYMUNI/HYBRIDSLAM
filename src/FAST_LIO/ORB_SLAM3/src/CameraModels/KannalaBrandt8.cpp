...
//BOOST_CLASS_EXPORT_GUID(KannalaBrandt8, "KannalaBrandt8")
    ...
    Eigen::Vector2d KannalaBrandt8::project(const Eigen::Vector3d &v3D) {
        ...
        // std::cout << "mvParameters[2] : " << mvParameters[2] << std::endl;
        // std::cout << "mvParameters[3] : " << mvParameters[3] << std::endl;
        // std::cout << "mvParameters[4] : " << mvParameters[4] << std::endl;
    ...
    Eigen::Matrix<double, 2, 3> KannalaBrandt8::projectJac(const Eigen::Vector3d &v3D) {
        ...
        // std::cout << "JacGood : " << JacGood << std::endl;
        // std::cout << "mvParameters[4] : " << mvParameters[4] << std::endl;
        // std::cout << "mvParameters[5] : " << mvParameters[5] << std::endl;
        // std::cout << "mvParameters[6] : " << mvParameters[6] << std::endl;
        // std::cout << "mvParameters[7] : " << mvParameters[7] << std::endl;
        // std::cout << "mvParameters[0] : " << mvParameters[0] << std::endl;
        // std::cout << "mvParameters[1] : " << mvParameters[1] << std::endl;
