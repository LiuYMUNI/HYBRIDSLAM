...
int Optimizer::PoseInertialOptimizationLastFrame(Frame *pFrame, bool bRecInit)
{
    if(pFrame->mbprior_pose)
    {
        ...
        // We perform 4 optimizations, after each optimization we classify observation as inlier/outlier
        // At the next optimization, outliers are not included, but at the end they can be classified as inliers again.
        const float chi2Mono[4]={2,2,2,2};
        const float chi2Stereo[4]={15.6f,9.8f,7.815f,7.815f};
        const int its[4]={10,10,10,10};
        ...
        std::cout << "calculated v1: " << std::endl;
        pFrame->mImuBias = IMU::Bias(b[3],b[4],b[5],b[0],b[1],b[2]);
        ...
        std::cout << "calculated v21: " << std::endl;
        H.block<3,3>(12,12) += Har.block<3,3>(0,0);
        H.block<3,3>(12,27) += Har.block<3,3>(0,3);
        H.block<3,3>(27,12) += Har.block<3,3>(3,0);
        H.block<3,3>(27,27) += Har.block<3,3>(3,3);
        std::cout << "calculated v22: " << std::endl;
        ...
        //         tot_out++;
        // }
        std::cout << "calculated v23: " << std::endl;
        // for(size_t i=0, iend=vpEdgesStereo.size(); i<iend; i++)
        // {
        //     EdgeStereoOnlyPose* e = vpEdgesStereo[i];
        ...
        //         tot_out++;
        // }
        std::cout << "calculated v3: " << std::endl;
        ...
        std::cout << "calculated v4: " << std::endl;
