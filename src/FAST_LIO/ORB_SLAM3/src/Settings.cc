...
namespace ORB_SLAM3 {
    ...
    ostream &operator<<(std::ostream& output, const Settings& settings){
        ...
        std::cout << "settings.sensor_ " << settings.sensor_ << std::endl;
        std::cout << "System::STEREO " << System::STEREO << std::endl;
        std::cout << "System::IMU_STEREO " << System::IMU_STEREO << std::endl;
        //settings.sensor_ == System::STEREO || settings.sensor_ == System::IMU_STEREO
        if(settings.sensor_ == System::STEREO || settings.sensor_ == System::IMU_STEREO){
            std::cout << "debug1.1 " << std::endl;
            std::cout << "settings.cameraType_ " << settings.cameraType_ << std::endl;
            std::cout << "Settings::PinHole " << Settings::PinHole << std::endl;
            std::cout << "Settings::Rectified " << Settings::Rectified << std::endl;
            std::cout << "settings.originalCalib2_->size() " << settings.originalCalib2_->size() << std::endl;
            ...
            output << "\t-Rectified stereo camera" << endl;
